...
export function OwnerEmptyState() {
  return (
    <div className="card-surface flex flex-col items-center px-6 py-10 text-center animate-fade-up">
      ...
      <h2 className="mt-4 text-lg font-bold text-slate-900">No active impound</h2>
      <p className="mt-2 max-w-[260px] text-sm leading-relaxed text-slate-500">
        Complete an impound as an officer first. When you tap{" "}
        <strong className="font-semibold text-slate-700">
          Confirm & notify owner
        </strong>
        , the case will appear here instantly.
      </p>
      <Link
        href="/officer"
